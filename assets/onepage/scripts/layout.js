    ...
    var handleHeaderPosition = function () {
        ...
        var headerFix = function(){
            ...
            if (CurrentWindowPosition > CurrentHeaderPosition) {
                ...
                $(".log").addClass("img");
                $(".header-con").addClass("cnt");
                // $(".ite").addClass("col-md-12");
                // $(".ite").removeClass("col-md-8");
                $(".header-navigation li").addClass("tie");

            } else {
                $(".header").removeClass("fixNav");
                $(".log").removeClass("img");
                $(".header-con").removeClass("cnt");
                // $(".ite").removeClass("col-md-12");
                // $(".ite").addClass("col-md-8");
                $(".header-navigation li").removeClass("tie");
            }
        };
