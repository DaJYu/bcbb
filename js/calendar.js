;!function(a) {
    ...
    var b = {
        ...
        max: today.getFullYear()+"-"+(today.getMonth()+1)+"-"+today.getDate()+" 23:59:59",
        isv: !1
    }
      , c = {}
      , d = document
      ...
      , h = ["laydate_box", "laydate_void", "laydate_click", "LayDateSkin", "skins/", "calendar.css"];
    ...
    c.run = function(a) {
        var d, e, b = c.query;
        if (a.tagName) {
            if (d = a.elem ? b(a.elem) : event.target || event.srcElement,
            !d || d === c.elem)
                return;
            c.view(d, a),
    ...
    c.initDate = function() {
        ...
        e.length < 3 && (c.options.start = c.options.start || "",
        e = c.options.start.match(/\d+/g) || [],
